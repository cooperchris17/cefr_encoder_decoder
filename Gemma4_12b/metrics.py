...
Single source of truth so the Gemma 4 (prompting) and T5Gemma 2 (fine-tuning)
experiments report numbers computed by *identical* code. Import `evaluate_predictions`
in both notebooks; do not reimplement per-experiment.
